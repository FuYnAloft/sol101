...
ANSWERS = [
    ...
    Answer(
        name="leetcode-easy",
        url="https://raw.githubusercontent.com/GMyhf/2024fall-cs101/refs/heads/main/2024fall_LeetCode_easy_problems.md",
        fullname="LeetCode - 易",
        title="LeetCode 简单题题解",
        details="LeetCode 简单难度题解",
        icon=IconVariants(
            light="/icons/leetcode-light.svg",
            dark="/icons/leetcode-dark.svg",
        ),
        action_theme="alt",
        welcome="欢迎来到 LeetCode 简单题题解，点击左边目录选择题目。中等和困难题目在隔壁。",
    ),
    Answer(
        name="leetcode-medium",
        url="https://raw.githubusercontent.com/GMyhf/2024fall-cs101/refs/heads/main/2024fall_LeetCode_medium_problems.md",
        fullname="LeetCode - 中",
        title="LeetCode 中等题题解",
        details="LeetCode 中等难度题解",
        icon=IconVariants(
            light="/icons/leetcode-light.svg",
            dark="/icons/leetcode-dark.svg",
        ),
        action_theme="alt",
        welcome="欢迎来到 LeetCode 中等题题解，点击左边目录选择题目。简单和困难题目在隔壁。",
    ),
    Answer(
        name="leetcode-tough",
